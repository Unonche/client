...
{:else}
  <div class="w-screen h-screen flex">
    ...
    <button on:click={() => drawerStore.open(leftDrawerSettings)} type="button" class="md:hidden btn-icon btn-icon-lg bg-primary-500 rounded-lg absolute bottom-0 left-0 ml-2 mb-2 shadow">
